...
public class OrderServiceImpl implements OrderService {
        ...
        command
          ...
          .map(item ->
            Order.OrderItem
              .builder()
              .medicine(
                medicineRepository.getById(UUID.fromString(item.medicineId()))
              )
  ...
  public Order update(UpdateOrderCommand command, UUID id) {
    var persistedEntity = equipmentRepository
      .findById(id)
  ...
  private Set<Order.OrderItem> mapUpdateCommandItemsToDomain(
